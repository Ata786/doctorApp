        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              ...
              Text('Sign In',style: TextStyle(fontSize: myHeight/30,color: R.colors.blackColor,fontFamily: 'worksans',fontWeight: FontWeight.bold),),
              ...
              child: Image.asset(R.images.SIGNIN_IMG),),
              SizedBox(height: myHeight/20),
              mainButton(color: R.colors.themeColor,text: 'Continue with Mobile Number',height: myHeight,width: myWidth,textColor: Colors.white,onTap: (){
                ...
                children: [
                  ...
                  InkWell(
                      onTap: (){
                        ...
                        Navigator.pushNamed(context, PagePath.SIGNUP_PAGE);
                      },
                      child: Text(' Sign Up Here',style: TextStyle(color: R.colors.themeColor,fontWeight: FontWeight.w700,fontSize: myHeight/60,fontFamily: 'worksans'),))
                ],
              ),
